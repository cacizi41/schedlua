...
local t1 = {Priority = 1000, TimePriority = 2000, pscore = 0.95Priority + 0.05TimePriority, name = "A"}
local t2 = {Priority = 500, TimePriority = 1000, pscore = 0.95Priority + 0.05TimePriority, name = "B"}
local t3 = {Priority = 200, TimePriority = 500, pscore = 0.95Priority + 0.05TimePriority, name = "C"}
local t4 = {Priority = 550, TimePriority = 400, pscore = 0.95Priority + 0.05TimePriority, name = "D"}
local t5 = {Priority = 650, TimePriority = 2000, pscore = 0.95Priority + 0.05TimePriority, name = "E"}
local t6 = {Priority = 800, TimePriority = 1000, pscore = 0.95Priority + 0.05TimePriority, name = "F"}
